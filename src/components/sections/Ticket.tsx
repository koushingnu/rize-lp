        ...
        <motion.div className="w-full space-y-12" variants={fadeInUp}>
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between">
              <div className="w-full lg:w-40 shrink-0 mb-4 lg:mb-0">
                <div
                  className="text-[15px] xs:text-[16px] sm:text-lg font-bold whitespace-nowrap bg-clip-text text-transparent bg-gradient-to-r from-blue-700 via-sky-400 to-blue-300"
                  style={{ fontFamily: "serif" }}
                >
                  チケット販売情報
                </div>
              ...
              <div
                className="w-full lg:w-[600px] text-[13px] xs:text-[14px] sm:text-base text-slate-700 space-y-2 sm:space-y-3"
                style={{ fontFamily: "serif" }}
              >
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-4 pl-4">
                      <div>
                        <div className="font-bold text-blue-800 text-[14px] xs:text-[15px] sm:text-base">
                          VIPチケット シーティング【一般販売】
                        </div>
                        <div className="pl-4 text-[13px] xs:text-[14px] sm:text-base leading-relaxed">
                          先着／お一人様1枚まで／WEB受付
                          <br />
